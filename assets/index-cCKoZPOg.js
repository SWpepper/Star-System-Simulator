...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ho(e,t,n){return new Ki({name:`SphericalGaussianBlur`,defines:{SAMPLES:Do,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:Go(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Uo(){return new Ki({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Go(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Wo(){return new Ki({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Go(),fragmentShader:`
	...
	`}var Ko=class extends Gt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ki(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `,transparent:!0,depthWrite:!1,side:1,blending:2,toneMapped:!1});return this.tracker.track(t)}createCorona(e,t){let n=new mi(this.tracker.track(new Li(e*1.075,64,48)),this.createCoronaMaterial(t));return n.name=`stellar-corona`,n}createProminenceTexture(e){let t=document.createElement(`canvas`);t.width=512,t.height=512;let n=t.getContext(`2d`),r=iu(e+9973);n.clearRect(0,0,t.width,t.height),n.globalCompositeOperation=`lighter`,n.lineCap=`round`;for(let e=0;e<110;e+=1){let e=r.range(0,Math.PI*2),t=r.range(58,148),i=r.range(-.34,.34),a=108+r.range(-8,16),o=a+t;n.beginPath(),n.strokeStyle=`rgba(255, 255, 255, ${r.range(.03,.21)})`,n.lineWidth=r.range(.45,2.6),n.moveTo(256+Math.cos(e)*a,256+Math.sin(e)*a),n.quadraticCurveTo(256+Math.cos(e+i*.35)*((a+o)*.5),256+Math.sin(e+i*.35)*((a+o)*.5),256+Math.cos(e+i)*o,256+Math.sin(e+i)*o),n.stroke()}for(let e=0;e<12;e+=1){let e=r.range(0,Math.PI*2),t=r.range(128,218);n.beginPath(),n.strokeStyle=`rgba(255, 255, 255, ${r.range(.08,.24)})`,n.lineWidth=r.range(2.5,7.5),n.moveTo(256+Math.cos(e)*108,256+Math.sin(e)*108),n.lineTo(256+Math.cos(e)*t,256+Math.sin(e)*t),n.stroke()}let i=new Ai(t);return i.colorSpace=Le,this.tracker.track(i)}createProminences(e,t,n){let r=new Cn;r.name=`solar-prominences`,r.userData.radius=e;let i=this.createProminenceTexture(n);for(let n of[{scale:2.25,opacity:.34,rotation:.2},{scale:3.05,opacity:.16,rotation:-1.15}]){let a=this.tracker.track(new Fr({map:i,color:new Y(t).lerp(new Y(16777215),.2),transparent:!0,opacity:n.opacity,depthWrite:!1,blending:2,toneMapped:!1}));a.rotation=n.rotation,a.userData.baseRotation=n.rotation,a.userData.baseOpacity=n.opacity;let o=new Yr(a);o.scale.set(e*n.scale,e*n.scale,1),r.add(o)}return r}createStarSurfaceMaterial(e,t){let n=new Y(t.render.baseColor).lerp(new Y(16777215),.28),r=new Ki({uniforms:{surfaceMap:{value:e},baseColor:{value:n},time:{value:t.render.seed*.001},intensity:{value:1.22}},vertexShader:`
        varying vec2 vUv;
        varying vec3 vNormal;
        varying vec3 vWorldPosition;
        void main() {
      ...
      `,toneMapped:!1});return this.tracker.track(r)}createStar(e){let t=this.capabilities.isLowPower?32:64,n=this.createSphere(e.render.radiusWorld,e,t),r=this.createGlow(e.render.radiusWorld,e.render.glowColor),i=this.createCorona(e.render.radiusWorld,e.render.glowColor),a=this.createProminences(e.render.radiusWorld,e.render.glowColor,e.render.seed),o=new Ra(e.render.glowColor,4.15,0,0);o.name=`${e.name}-light`,o.position.copy(n.position),this.root.add(o),this.root.add(r),this.root.add(i),this.root.add(a),this.views.set(e.id,{body:e,mesh:n,glowGroup:r,corona:i,prominences:a,light:o,parentId:null})}createGlowTexture(){if(this.glowTexture)return this.glowTexture;let e=document.createElement(`canvas`);e.width=256,e.height=256;let t=e.getContext(`2d`),n=t.createRadialGradient(128,128,0,128,128,128);return n.addColorStop(0,`rgba(255, 255, 255, 1)`),n.addColorStop(.12,`rgba(255, 255, 255, 0.82)`),n.addColorStop(.3,`rgba(255, 255, 255, 0.32)`),n.addColorStop(.62,`rgba(255, 255, 255, 0.08)`),n.addColorStop(1,`rgba(255, 255, 255, 0)`),t.fillStyle=n,t.fillRect(0,0,e.width,e.height),this.glowTexture=this.tracker.track(new Ai(e)),this.glowTexture.colorSpace=Le,this.glowTexture}createGlow(e,t){let n=new Cn,r=this.createGlowTexture();for(let i of[{scale:2.8,opacity:.52},{scale:4.6,opacity:.2}]){let a=new Yr(this.tracker.track(new Fr({map:r,color:t,transparent:!0,opacity:i.opacity,depthWrite:!1,blending:2,toneMapped:!1})));a.scale.set(e*i.scale,e*i.scale,1),n.add(a)}return n}createCloudLayer(e){if(![`earth`,`cloudy`,`ice`].includes(e.render.appearance))return null;let t=this.capabilities.isLowPower?256:512,n=this.capabilities.isLowPower?128:256,r=Gu(e),i=r?this.textureFactory.createFromUrl(r,{name:`${e.name}-clouds`,width:2048,height:1024}):this.textureFactory.create({kind:`cloud`,appearance:e.render.appearance,color:16777215,seed:e.render.seed+1777,width:t,height:n}),a=new mi(this.tracker.track(new Li(e.render.radiusWorld*1.015,48,32)),this.tracker.track(new Ji({map:i,transparent:!0,opacity:e.render.appearance===`ice`?.28:.68,depthWrite:!1,alphaTest:.015,roughness:1,metalness:0})));return a.name=`${e.name}-clouds`,a.rotation.z=e.render.seed%2?.12:-.12,a}createAtmosphere(e){let t=Ju(e);return!t.atmosphere||t.intensity<=0?null:new mi(this.tracker.track(new Li(e.render.radiusWorld*1.075,48,32)),this.tracker.track(new Ki({uniforms:{glowColor:{value:new Y(t.atmosphere)},intensity:{value:t.intensity}},vertexShader:`
          varying vec3 vNormal;
          varying vec3 vWorldPosition;
          void main() {
            vNormal = normalize(mat3(modelMatrix) * normal);
        ...
        `,transparent:!0,depthWrite:!1,side:1,blending:2})))}createPlanet(e){let t=this.capabilities.isLowPower?32:64,n=this.createSphere(e.render.radiusWorld,e,t),r=this.createCloudLayer(e),i=this.createAtmosphere(e);if(r&&n.add(r),i&&n.add(i),e.render.hasRings){let t=this.tracker.track(new Ii(e.render.radiusWorld*1.42,e.render.radiusWorld*2.9,160,3)),r=this.textureFactory.createFromUrl(Uu.saturnRing,{name:`${e.name}-ring`,width:2048,height:1024,clamp:!0}),i=new mi(t,this.tracker.track(new Ji({map:r,transparent:!0,side:2,opacity:.96,depthWrite:!1,roughness:.82,metalness:0,emissive:new Y(e.render.baseColor).multiplyScalar(.04)})));i.rotation.x=Math.PI/2,n.add(i)}this.views.set(e.id,{body:e,mesh:n,cloudMesh:r,glowGroup:null,light:null,parentId:e.parentId}),this.createOrbit(e.orbit);for(let t of e.satellites){let r=this.createSphere(t.render.radiusWorld,t,this.capabilities.isLowPower?20:32);n.add(r),this.views.set(t.id,{body:t,mesh:r,cloudMesh:null,glowGroup:null,light:null,parentId:e.id})}}createOrbit(e){if(!e||e.radiusWorld<=0||e.center===`parent`)return null;let t=new mi(this.tracker.track(new Ii(e.radiusWorld-.3,e.radiusWorld+.3,128)),this.tracker.track(new ni({color:3368618,transparent:!0,opacity:.25,side:2,depthWrite:!1})));return t.rotation.x=Math.PI/2,this.root.add(t),t}update(e,t=0){this.elapsedTime+=t;for(let n of this.views.values()){let{body:r,mesh:i,glowGroup:a,corona:o,prominences:s,light:c,cloudMesh:l}=n;if(r.kind===`star`&&r.orbit){let t=qu(r,e);i.position.set(Math.cos(t)*r.orbit.radiusWorld,0,Math.sin(t)*r.orbit.radiusWorld)}else if(r.kind===`planet`&&r.orbit){let n=r.orbit.centerId?this.getWorldPosition(r.orbit.centerId):{x:0,z:0},a=qu(r,e);i.position.set(n.x+Math.cos(a)*r.orbit.radiusWorld,0,n.z+Math.sin(a)*r.orbit.radiusWorld),i.rotation.y+=r.render.rotationSpeed*t}else if(r.kind===`moon`&&r.orbit){let n=qu(r,e);i.position.set(Math.cos(n)*r.orbit.radiusWorld,Math.sin(n*.3)*.5,Math.sin(n)*r.orbit.radiusWorld),i.rotation.y+=r.render.rotationSpeed*t}a&&a.position.copy(i.position),c&&c.position.copy(i.position);let u=this.camera?this.camera.position.distanceTo(i.position):1/0;if(o&&(o.position.copy(i.position),o.visible=u>r.render.radiusWorld*1.2,o.material.uniforms?.time&&(o.material.uniforms.time.value=this.elapsedTime)),i.material.uniforms?.time&&(i.material.uniforms.time.value=this.elapsedTime+r.render.seed*.001),s){s.position.copy(i.position);let e=s.userData.radius??r.render.radiusWorld,t=e*2.2,n=e*5.8,a=Math.max(0,Math.min(1,(u-t)/(n-t)));s.visible=a>.02,s.children.forEach((e,t)=>{e.material.rotation=e.material.userData.baseRotation+this.elapsedTime*(t===0?.008:-.005),e.material.opacity=e.material.userData.baseOpacity*a*(.86+Math.sin(this.elapsedTime*.32+t*1.7)*.14)})}l&&(l.rotation.y+=t*.035)}}getWorldPosition(e){let t=this.views.get(e);if(!t)return{x:0,y:0,z:0};let n=t.mesh.getWorldPosition(new K);return{x:n.x,y:n.y,z:n.z}}getBody(e){return this.views.get(e)?.body??null}pick(e){let t=[...this.views.values()].map(e=>e.mesh),n=e.intersectObjects(t,!0)[0];if(!n)return null;let r=n.object;for(;r&&!r.userData.body;)r=r.parent;return r?.userData.body??null}dispose(){this.root&&=(this.scene.remove(this.root),this.root.clear(),null),this.tracker.disposeAll(),this.glowTexture=null,this.views.clear(),this.model=null}};function Xu(e,t,n){let r=Math.imul(e|0,374761393)^Math.imul(t|0,668265263)^(n|0);return r=Math.imul(r^r>>>13,1274126177),((r^r>>>16)>>>0)/4294967295}function Zu(e,t,n){let r=Math.max(0,Math.min(1,(n-e)/(t-e)));return r*r*(3-2*r)}function Qu(e,t,n){let r=Math.floor(e),i=Math.floor(t),a=Zu(0,1,e-r),o=Zu(0,1,t-i),s=Xu(r,i,n),c=Xu(r+1,i,n),l=Xu(r,i+1,n),u=Xu(r+1,i+1,n),d=s+(c-s)*a;return d+(l+(u-l)*a-d)*o}function $u(e,t,n,r=4,i=2,a=.5){let o=0,s=.5,c=1,l=0;for(let u=0;u<r;u+=1)o+=Qu(e*c,t*c,n+u*1013)*s,l+=s,s*=a,c*=i;return o/l}function ed(e,t,n,r=4){let i=0,a=.55,o=1,s=0;for(let c=0;c<r;c+=1){let r=Qu(e*o,t*o,n+c*1543);i+=(1-Math.abs(r*2-1))*a,s+=a,a*=.5,o*=2.05}return i/s}function td(e){return{r:e>>16&255,g:e>>8&255,b:e&255}}function nd(e){return Math.max(0,Math.min(255,Math.round(e)))}function rd(e,t,n){return e+(t-e)*n}function id(e,t,n,r,i,a,o=1){let s=0,c=Math.min(n,r);for(let l=0;l<a;l+=1){let a=Xu(l*17,i,71)*n,u=Xu(l*31,i,113)*r,d=(1.5+Xu(l,i,211)*.045*c)*o,f=Math.hypot(e-a,t-u);if(f<d){let e=f/d;s+=e>.76?.25*(1-e):-.38*(1-e)}}return s}function ad(e,t,n,r,i,a){let o=$u(n*.017+(Qu(n*.008,r*.008,i+301)-.5)*7,r*.017+(Qu(n*.008,r*.008,i+401)-.5)*7,i,5),s=$u(n*.085,r*.085,i+17,3),c=id(n,r,e*900,t*360,i,24,1.25),l=Zu(.72,.96,Math.abs(t*2-1)),u=Math.max(.08,Math.min(1,o*.56+s*.3+c+l*.16)),d=.6+u*.68-s*.08;return{r:rd(a.r*d,235,l*.78),g:rd(a.g*d,238,l*.78),b:rd(a.b*d,242,l*.78),height:u,cloud:0}}function od(e,t,n,r,i,a){let o=$u(n*.013,r*.018,i+77,5)-.5,s=(Math.sin((e*48+o*11)*Math.PI)+1)*.5,c=$u(n*.075,r*.075,i+91,3),l=Zu(.78,.94,ed(n*.009,r*.009,i+131,4)),u=Math.max(.12,s*.48+c*.33-l*.28);return{r:a.r*(.78+u*.5),g:a.g*(.68+u*.4-l*.12),b:a.b*(.55+u*.3-l*.08),height:u,cloud:0}}function sd(e,t,n,r,i){let a=$u(n*.009,r*.009,i+401,5)-.5,o=$u(n*.019+a*2.4,r*.019-a*1.5,i,6),s=ed(n*.038,r*.038,i+71,4),c=$u(n*.017,r*.013,i+311,5),l=Zu(.72,.95,Math.abs(t*2-1)+(o-.5)*.08),u=Zu(.48,.72,c+Math.sin(e*18+o*5)*.05),d=o>.48,f,p,m,h;if(d){let e=Zu(.48,.82,o);f=rd(58,144,e)+s*34,p=rd(104,84,e)+s*24,m=rd(52,48,e)+s*18,h=.52+e*.38+s*.12}else{let e=Zu(.25,.48,o);f=rd(4,22,e),p=rd(42,108,e),m=rd(92,196,e),h=.08+e*.12}return Math.abs(o-.48)<.012&&(f=rd(f,205,.78),p=rd(p,184,.78),m=rd(m,126,.78)),f=rd(f,236,l),p=rd(p,242,l),m=rd(m,248,l),{r:f,g:p,b:m,height:h,cloud:u}}function cd(e,t,n,r,i,a){let o=$u(n*.012,r*.028,i+201,5),s=Qu(e*4,t*9,i+51),c=(Math.sin(t*42+s*6+o*3)+1)*.5,l=(e-.68)/.11,u=(t-.61)/.07,d=Math.max(0,1-l*l-u*u),f=.72+c*.48+o*.12+d*.18,p=Zu(.48,.92,c);return{r:a.r*f*(1+p*.08),g:a.g*f*(.88+p*.12),b:a.b*f*(.72+(1-p)*.18),height:.35+o*.08,cloud:0}}function ld(e,t,n,r,i,a){let o=$u(n*.018,r*.018,i+31,5),s=1-Zu(.01,.055,Math.abs(Qu(n*.052,r*.052,i+71)-.5)),c=ed(n*.085,r*.085,i+111,3),l=Math.abs(t*2-1),u=.28+o*.34-s*.24+c*.1,d=.78+o*.28+c*.08-s*.2;return{r:rd(a.r*d,224,Zu(.55,.95,l)*.22),g:rd(a.g*d,239,Zu(.55,.95,l)*.22),b:rd(a.b*d,255,Zu(.55,.95,l)*.18),height:u,cloud:Zu(.7,.94,c)*.18}}function ud(e,t,n,r,i,a){let o=(Qu(n*.008,r*.011,i+51)-.5)*7,s=$u(n*.022+o,r*.014,i,6),c=Math.sin(e*22+s*8+t*10)*.12,l=Math.max(.12,s+c),u=Zu(.35,.8,s),d=Zu(.42,.7,s+c*.4);return{r:rd(a.r*.82,248,u*.24)*(.86+l*.3),g:rd(a.g*.82,230,u*.18)*(.84+l*.28),b:rd(a.b*.75,188,u*.12)*(.76+l*.3),height:l,cloud:d}}function dd(e,t,n,r,i,a,o){switch(e){case`earth`:return sd(t,n,r,i,a);case`cloudy`:return ud(t,n,r,i,a,o);case`desert`:return od(t,n,r,i,a,o);case`gas`:return cd(t,n,r,i,a,o);case`ice`:return ld(t,n,r,i,a,o);default:return ad(t,n,r,i,a,o)}}function fd(e,t,n,r,i,a){let o=$u(n*.045+Math.sin(r*.017+i)*4.5,r*.045+Math.cos(n*.013+i)*4.5,i,6),s=$u(n*.13,r*.13,i+451,3),c=(Math.max(0,Qu(n*.018,r*.018,i+91)-.54)*2.2)**2.2,l=.54+o*.7+s*.18+c*.56;return{r:a.r*l+c*28,g:a.g*l+c*20,b:a.b*l+c*12,alpha:255}}function pd(e,t,n,r){let i=e,a=$u(t*.22,n*.18,r,4),o=Qu(i*22,.5,r+71),s=.36+o*.34+a**1.8*.34,c=[{position:.18,width:.015,depth:.22},{position:.31,width:.024,depth:.12},{position:.51,width:.012,depth:.08},{position:.68,width:.019,depth:.18},{position:.83,width:.012,depth:.26}],l=s;for(let e of c)Math.abs(i-e.position)<e.width&&(l*=e.depth);(i<.07||i>.94)&&(l*=Zu(0,.07,Math.min(i,1-i)));let u=.72+a*.36+o*.12;return{r:224*u,g:214*u,b:184*u,alpha:l*255}}function md(e,t,n,r,i){let a=$u(n*.04,r*.04,i,5),o=id(n,r,e*512,t*256,i+7,27,.72),s=Zu(.72,.95,Math.abs(t*2-1)),c=Math.max(.05,Math.min(1,a*.7+o+s*.12)),l=82+c*104;return{r:l,g:l*.98,b:l*.94,height:c,cloud:0}}function hd({kind:e,appearance:t=`rocky`,color:n=8947848,seed:r=1,width:i,height:a}){let o=new Uint8ClampedArray(i*a*4),s=td(n);for(let n=0;n<a;n+=1)for(let c=0;c<i;c+=1){let l=(n*i+c)*4,u=c/i,d=n/a,f;if(f=e===`star`?fd(u,d,c,n,r,s):e===`ring`?pd(u,c,n,r):e===`moon`||t===`moon`?md(u,d,c,n,r):dd(t,u,d,c,n,r,s),e===`bump`){let e=nd(88+(f.height??.4)*150);o[l]=e,o[l+1]=e,o[l+2]=e,o[l+3]=255}else if(e===`cloud`){let e=nd((f.cloud??0)*255);o[l]=242,o[l+1]=248,o[l+2]=255,o[l+3]=e}else o[l]=nd(f.r),o[l+1]=nd(f.g),o[l+2]=nd(f.b),o[l+3]=nd(f.alpha??255)}return o}function gd(e,t,n){let r=document.createElement(`canvas`);r.width=t,r.height=n;let i=r.getContext(`2d`);return i.fillStyle=`#${e.toString(16).padStart(6,`0`)}`,i.fillRect(0,0,t,n),r}function _d(e,t,n,r){e.image.getContext(`2d`).putImageData(new ImageData(t,n,r),0,0),e.needsUpdate=!0}var vd=class{constructor({capabilities:e,tracker:t,workerPool:n}){this.capabilities=e,this.tracker=t,this.workerPool=n,this.assetTextures=new Map}createFromUrl(e,t={}){let r=t.width??2048,i=t.height??1024,a=`${e}|${r}|${i}|${t.colorSpace??`srgb`}|${t.clamp?`clamp`:`repeat`}`,o=this.assetTextures.get(a);if(o)return o;let s=new Ai(gd(t.color??4937320,r,i));s.name=t.name??e,s.colorSpace=t.colorSpace??`srgb`,s.magFilter=c,s.minFilter=u,s.generateMipmaps=!0,s.anisotropy=this.capabilities.isLowPower?2:8,t.clamp||(s.wrapS=n,s.wrapT=n);let l=!1,d=s.dispose.bind(s);return s.dispose=()=>{l||(l=!0,d())},new Sa().load(e,e=>{if(l){e.dispose();return}let t=s.image.getContext(`2d`);t.clearRect(0,0,r,i),t.drawImage(e.image,0,0,r,i),s.needsUpdate=!0,e.dispose()},void 0,t=>console.warn(`材质加载失败: ${e}`,t)),this.assetTextures.set(a,s),s}dispose(){for(let e of this.assetTextures.values())e.dispose();this.assetTextures.clear()}create(e){let t=this.capabilities.textureScale,r=Math.max(64,Math.round(e.width*t)),i=Math.max(32,Math.round(e.height*t)),a=new Ai(gd(e.kind===`bump`?9079434:e.color??8947848,r,i));a.colorSpace=e.kind===`bump`?``:Le,a.name=`${e.kind}-${e.seed}`,a.magFilter=c,a.minFilter=u,a.generateMipmaps=!0,a.anisotropy=this.capabilities.isLowPower?2:8,e.kind!==`ring`&&(a.wrapS=n,a.wrapT=n);let o=!1,s=a.dispose.bind(a);a.dispose=()=>{o||(o=!0,s())},this.tracker.track(a);let l={...e,width:r,height:i},d=()=>{if(o)return;let t=hd({...e,width:r,height:i});_d(a,t,r,i)};return this.workerPool.available?this.workerPool.request(l).then(e=>{if(o){e.close();return}let t=a.image.getContext(`2d`);t.clearRect(0,0,r,i),t.drawImage(e,0,0,r,i),e.close(),a.needsUpdate=!0}).catch(()=>d()):queueMicrotask(d),a}},yd=class{constructor(e=0){this.workers=[],this.pending=new Map,this.nextRequestId=1,this.nextWorkerIndex=0;for(let t=0;t<e;t+=1)try{let e=new Worker(new URL(new URL(`texture.worker-D1VH2yKb.js`,import.meta.url).href,``+import.meta.url),{type:`module`});e.addEventListener(`message`,t=>this.handleMessage(e,t.data)),e.addEventListener(`error`,()=>this.handleWorkerFailure(e)),this.workers.push(e)}catch(e){console.warn(`纹理 Worker 不可用，将使用主线程降级:`,e)}}get available(){return this.workers.length>0}request(e){if(!this.available)return Promise.reject(Error(`Texture workers are unavailable.`));let t=this.workers[this.nextWorkerIndex%this.workers.length];this.nextWorkerIndex+=1;let n=this.nextRequestId;return this.nextRequestId+=1,new Promise((r,i)=>{this.pending.set(n,{resolve:r,reject:i,worker:t}),t.postMessage({id:n,options:e})})}handleMessage(e,t){let n=this.pending.get(t.id);if(n){if(this.pending.delete(t.id),t.error){n.reject(Error(t.error));return}n.resolve(t.bitmap)}}handleWorkerFailure(e){for(let[t,n]of this.pending)n.worker===e&&(this.pending.delete(t),n.reject(Error(`Texture worker failed.`)))}dispose(){for(let e of this.pending.values())e.reject(Error(`Texture worker pool disposed.`));this.pending.clear();for(let e of this.workers)e.terminate();this.workers=[]}},bd=new URL(new URL(`background-DoUCEGk3.mp3`,import.meta.url).href,``+import.meta.url).href,xd=class{constructor({onStateChange:e}={}){this.audio=new Audio(bd),this.audio.loop=!0,this.audio.preload=`none`,this.audio.volume=.3,this.playing=!1,this.onStateChange=e??(()=>{})}async play(){try{await this.audio.play(),this.playing=!0,this.onStateChange(!0)}catch(e){this.playing=!1,this.onStateChange(!1),console.warn(`音频播放失败:`,e)}}pause(){this.audio.pause(),this.playing=!1,this.onStateChange(!1)}toggle(){if(this.playing){this.pause();return}this.play()}setVolume(e){this.audio.volume=Math.max(0,Math.min(1,e/100))}dispose(){this.audio.pause(),this.audio.removeAttribute(`src`),this.audio.load()}};function $(e){return document.getElementById(e)}function Sd(e){return e<1?`${e.toFixed(1)}x`:`${e}x`}var Cd=class{constructor(e){this.callbacks=e,this.uiVisible=!0,this.currentYear=null,this.previousFocus=null,this.bind()}bind(){$(`btn-pause`).addEventListener(`click`,()=>this.callbacks.onPause()),$(`btn-faster`).addEventListener(`click`,()=>this.callbacks.onSpeedUp()),$(`btn-slower`).addEventListener(`click`,()=>this.callbacks.onSlowDown()),$(`btn-close`).addEventListener(`click`,()=>this.hideBody()),$(`btn-destroy`).addEventListener(`click`,()=>{confirm(`确定要毁灭这个星系吗？这将清除所有天体并生成新的星系。`)&&this.callbacks.onDestroy()}),$(`btn-solar-system`).addEventListener(`click`,()=>{confirm(`生成太阳系？当前星系将被替换。`)&&this.callbacks.onSolarSystem()}),$(`btn-toggle-ui`).addEventListener(`click`,()=>this.toggleVisibility()),$(`btn-music`).addEventListener(`click`,()=>this.callbacks.onMusicToggle()),$(`volume-slider`).addEventListener(`input`,e=>{this.callbacks.onVolumeChange(Number(e.target.value))});let e=$(`help-modal`);$(`btn-help`).addEventListener(`click`,()=>this.showHelp()),$(`btn-close-help`).addEventListener(`click`,()=>this.hideHelp()),e.addEventListener(`click`,t=>{t.target===e&&this.hideHelp()}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&this.hideHelp()})}setGalaxy(e){$(`galaxy-label`).textContent=e.endsWith(`星系`)||e===`太阳系`?e:`${e}星系`}setYear(e){e!==this.currentYear&&(this.currentYear=e,$(`year-value`).textContent=String(e))}setPaused(e){let t=$(`btn-pause`);t.textContent=e?`▶`:`▶▶`,t.setAttribute(`aria-label`,e?`继续模拟`:`暂停模拟`)}setSpeed(e){$(`speed-display`).textContent=Sd(e)}setMusicPlaying(e){let t=$(`btn-music`);t.classList.toggle(`playing`,e),t.textContent=e?`🔊`:`♪`,t.setAttribute(`aria-label`,e?`暂停音乐`:`播放音乐`)}showInfo(e,t){$(`info-panel`).classList.remove(`hidden`),$(`body-name`).textContent=e.name,$(`body-type`).textContent=e.type,$(`body-mass`).textContent=fu(e.massKg);let n=$(`planet-type-row`),r=$(`life-row`),i=$(`destroy-section`),a=$(`radius-label`);if(e.kind===`star`)n.classList.add(`hidden`),r.classList.add(`hidden`),i.classList.remove(`hidden`),a.textContent=`表面温度`,$(`body-radius`).textContent=e.meta.temperatureK?`${e.meta.temperatureK.toLocaleString()} K`:`-`,$(`body-orbital-radius`).textContent=`-`,$(`body-orbital-period`).textContent=`-`;else if(e.kind===`moon`)n.classList.add(`hidden`),r.classList.add(`hidden`),i.classList.add(`hidden`),a.textContent=`半径`,$(`body-radius`).textContent=`${e.render.radiusWorld.toFixed(1)} 单位`,$(`body-orbital-radius`).textContent=`${e.orbit.radiusWorld.toFixed(1)} 单位`,$(`body-orbital-period`).textContent=`${(e.orbit.periodYears*365.25).toFixed(1)} 天`;else{i.classList.add(`hidden`),n.classList.remove(`hidden`),r.classList.remove(`hidden`),a.textContent=`半径`,$(`body-radius`).textContent=`${e.render.radiusWorld.toFixed(1)} 单位`,$(`body-planet-type`).textContent=e.meta.planetType.type,$(`body-orbital-radius`).textContent=`${e.orbit.radiusAu.toFixed(2)} AU`,$(`body-orbital-period`).textContent=`${e.orbit.periodYears.toFixed(3)} 年`;let t=$(`body-life`);t.textContent=e.meta.lifeStatus,t.className=`info-value ${e.meta.lifeStatus===`无生命迹象`?`life-no`:`life-possible`}`}let o=$(`satellites-section`),s=$(`satellites-list`);s.replaceChildren();let c=t.planets.find(t=>t.id===e.id)?.satellites??[];if(c.length>0){o.classList.remove(`hidden`);for(let e of c){let t=document.createElement(`li`);t.textContent=e.name,t.tabIndex=0,t.addEventListener(`click`,()=>this.callbacks.onSelectBody(e.id)),t.addEventListener(`keydown`,t=>{(t.key===`Enter`||t.key===` `)&&(t.preventDefault(),this.callbacks.onSelectBody(e.id))}),s.appendChild(t)}}else o.classList.add(`hidden`)}hideBody(){$(`info-panel`).classList.add(`hidden`)}showHelp(){this.previousFocus=document.activeElement,$(`help-modal`).classList.remove(`hidden`),$(`btn-close-help`).focus()}hideHelp(){$(`help-modal`).classList.add(`hidden`),this.previousFocus instanceof HTMLElement&&this.previousFocus.focus()}toggleVisibility(){this.uiVisible=!this.uiVisible;for(let e of[`time-panel`,`solar-system-panel`,`help-panel`,`hint`])$(e).classList.toggle(`hidden`,!this.uiVisible);let e=$(`btn-toggle-ui`);e.textContent=this.uiVisible?`UI`:`👁`,e.classList.toggle(`active`,!this.uiVisible),e.setAttribute(`aria-label`,this.uiVisible?`隐藏界面`:`显示界面`)}hideLoading(){$(`loading`).classList.add(`hidden`)}showFatal(e){$(`loading`).classList.add(`hidden`);let t=$(`fatal-error`);$(`fatal-error-message`).textContent=e,t.classList.remove(`hidden`)}};function wd(){if(globalThis.crypto?.getRandomValues){let e=new Uint32Array(1);return globalThis.crypto.getRandomValues(e),e[0]}return Date.now()}var Td=class{constructor(e){this.container=e,this.capabilities=$l(),this.sharedTracker=new nu,this.systemTracker=new nu,this.simulationClock=new tu,this.renderClock=new Ga,this.renderClock.connect(document),this.renderClock.update(),this.running=!0,this.visible=!document.hidden,this.firstFrameRendered=!1,this.selectedBodyId=null,this.targetPosition=new K,this.mouse=new G,this.raycaster=new oo,this.scene=new jn,this.scene.background=new Y(5),this.camera=new Ia(60,window.innerWidth/window.innerHeight,.1,1e4),this.camera.position.set(0,100,200),this.renderer=new Al({antialias:!0,powerPreference:`high-performance`}),this.renderer.toneMapping=4,this.renderer.toneMappingExposure=1.26,this.renderer.setPixelRatio(this.resolvePixelRatio()),this.renderer.setSize(window.innerWidth,window.innerHeight),this.container.appendChild(this.renderer.domElement),this.controls=new Bl(this.camera,this.renderer.domElement),this.controls.enableDamping=!0,this.controls.dampingFactor=.05,this.controls.minDistance=2.5,this.controls.zoomSpeed=1.35,this.controls.zoomToCursor=!0,this.controls.maxDistance=2e3,this.controls.target.set(0,0,0),this.starfield=Tu({count:this.capabilities.starCount,tracker:this.sharedTracker}),this.scene.add(this.starfield),this.workerPool=new yd(this.capabilities.workerCount),this.textureFactory=new vd({capabilities:this.capabilities,tracker:this.systemTracker,workerPool:this.workerPool}),this.systemScene=new Yu({scene:this.scene,textureFactory:this.textureFactory,tracker:this.systemTracker,capabilities:this.capabilities,camera:this.camera}),this.ui=new Cd({onPause:()=>this.togglePause(),onSpeedUp:()=>this.setSpeed(this.simulationClock.speedUp()),onSlowDown:()=>this.setSpeed(this.simulationClock.slowDown()),onDestroy:()=>this.replaceSystem({mode:`random`}),onSolarSystem:()=>this.replaceSystem({mode:`solar`}),onSelectBody:e=>this.selectBody(e),onMusicToggle:()=>this.audio.toggle(),onVolumeChange:e=>this.audio.setVolume(e)}),this.ui.setPaused(!1),this.ui.setSpeed(this.simulationClock.speed),this.ui.hideBody(),this.audio=new xd({onStateChange:e=>this.ui.setMusicPlaying(e)}),this.onResize=()=>this.resize(),this.onClick=e=>this.handleClick(e),this.onVisibilityChange=()=>{this.visible=!document.hidden,this.visible&&this.renderClock.getDelta()},this.onBeforeUnload=()=>this.dispose(),window.addEventListener(`resize`,this.onResize),this.renderer.domElement.addEventListener(`click`,this.onClick),document.addEventListener(`visibilitychange`,this.onVisibilityChange),window.addEventListener(`beforeunload`,this.onBeforeUnload,{once:!0}),this.loadSystem(wu({mode:`random`,seed:wd()})),this.animate=this.animate.bind(this),this.animationFrame=requestAnimationFrame(this.animate)}loadSystem(e){this.selectedBodyId=null,this.controls.minDistance=2.5,this.targetPosition.set(0,0,0),this.controls.target.set(0,0,0),this.camera.position.set(0,100,200),this.simulationClock.reset(),this.systemScene.load(e),this.systemScene.update(0,0),this.ui.setGalaxy(e.galaxyNumber),this.ui.setYear(this.simulationClock.displayYear),this.ui.setPaused(!1),this.ui.setSpeed(this.simulationClock.speed),this.ui.hideBody()}replaceSystem(e){this.loadSystem(wu({mode:e.mode,seed:wd()}))}togglePause(){this.ui.setPaused(this.simulationClock.togglePause())}setSpeed(e){this.ui.setSpeed(e)}selectBody(e){let t=this.systemScene.getBody(e);t&&(this.selectedBodyId=e,this.controls.minDistance=Math.max(1.2,t.render.radiusWorld*1.15),this.ui.showInfo(t,this.systemScene.model))}handleClick(e){let t=this.renderer.domElement.getBoundingClientRect();this.mouse.x=(e.clientX-t.left)/t.width*2-1,this.mouse.y=-((e.clientY-t.top)/t.height)*2+1,this.raycaster.setFromCamera(this.mouse,this.camera);let n=this.systemScene.pick(this.raycaster);n&&this.selectBody(n.id)}update(e){if(this.simulationClock.update(e),this.selectedBodyId){let e=this.systemScene.getWorldPosition(this.selectedBodyId);this.targetPosition.set(e.x,e.y,e.z),this.controls.target.lerp(this.targetPosition,.05)}this.systemScene.update(this.simulationClock.elapsedYears,e),this.ui.setYear(this.simulationClock.displayYear),this.controls.update()}animate(e){if(!this.running)return;this.animationFrame=requestAnimationFrame(this.animate),this.renderClock.update(e);let t=this.renderClock.getDelta();this.visible&&(this.update(t),this.renderer.render(this.scene,this.camera),this.firstFrameRendered||(this.firstFrameRendered=!0,this.ui.hideLoading(),document.documentElement.dataset.appReady=`true`))}resolvePixelRatio(){return Math.min(Math.max(window.devicePixelRatio,this.capabilities.minPixelRatio),this.capabilities.maxPixelRatio)}resize(){this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.renderer.setPixelRatio(this.resolvePixelRatio()),this.renderer.setSize(window.innerWidth,window.innerHeight)}dispose(){this.running&&(this.running=!1,cancelAnimationFrame(this.animationFrame),window.removeEventListener(`resize`,this.onResize),this.renderer.domElement.removeEventListener(`click`,this.onClick),document.removeEventListener(`visibilitychange`,this.onVisibilityChange),this.systemScene.dispose(),this.textureFactory.dispose(),this.workerPool.dispose(),this.sharedTracker.disposeAll(),this.audio.dispose(),this.renderClock.dispose(),this.controls.dispose(),this.renderer.dispose(),this.renderer.domElement.remove())}};try{let e=document.getElementById(`container`);if(!e)throw Error(`缺少 3D 渲染容器。`);new Td(e)}catch(e){console.error(`恒星系模拟器启动失败:`,e);let t=document.getElementById(`loading`),n=document.getElementById(`fatal-error`),r=document.getElementById(`fatal-error-message`);t?.classList.add(`hidden`),n?.classList.remove(`hidden`),r&&(r.textContent=e instanceof Error?e.message:`当前浏览器无法初始化 3D 渲染。`)}